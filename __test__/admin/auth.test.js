...
beforeAll(async function (){
  try {
    ...
    inserted_company = await company.insertOne({
      company_id: 328,
      company_name: 'wireless',
      id: '6226ee15384cea130c087cc9'
    });
    const user = db.collection('user');
    inserted_user = await user.insertOne({
      user_id: 336,
      user_name: 'deploy',
      email: 'Elliot_Emard@hotmail.com',
      user_company: '6226ee15384cea130c087cca',
      designation: 'payment',
      password: 'xlZxp0rLOdJPa3r',
      experties: 'orchid',
      mobileNo: '881.816.0422',
      username: 'Frederic.Watsica',
      role: 931,
      resetPasswordLink: {},
      loginRetryLimit: 996,
      loginReactiveTime: '2023-03-02T02:52:19.417Z',
      id: '6226ee15384cea130c087ccb'
    });
  }
  catch (err) {
  ...
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'user_id':185,
        'user_name':'Monitored',
        'email':'Murl_DuBuque@hotmail.com',
        'user_company':inserted_company.insertedId,
        'designation':'Inverse',
        'password':'hOEidn5ApKGc0yY',
        'experties':'face',
        'mobileNo':'729-593-6619',
        'username':'Mikayla_Steuber2',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Murl_DuBuque@hotmail.com', });
